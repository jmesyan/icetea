  ...
  var log = require('pomelo-logger').getLogger("game", "Protocol");
  var Protocol = function(){};
  var _proto_ = Protocol.prototype;
  ...
  var Package = _proto_.Package = {};
  var Message = _proto_.Message = {};
   ...
   */
  _proto_.strencode = function(str) {
    var buffer = Buffer.alloc(str.length * 3);
    var offset = 0;
   ...
   */
  _proto_.strdecode = function(buffer) {
  ...
  var copyArray = function(dest, doffset, src, soffset, length) {
    if('function' === typeof src.copy) {
      // Buffer
      src.copy(dest, doffset, soffset, soffset + length+1);
    } else {
      // Uint8Array
